import {
  ...
  isObjectEmpty,
  objectEquals,
} from 'fantom-vue-components/src/utils';
  ...
  methods: {
    ...
    _getPaginationVariables(pagination) {
      ...
      if (
        ...
        paginationVars.last =
          pagination.totalItems % pagination.perPage || this.perPage;
    ...
    async _onPageChange(pagination) {
      ...
      if (
        (this.pageInfo.hasNextPage || pagination.isLastPage) &&
        data &&
        data.edges &&
        data.edges.length > 0
      ) {
