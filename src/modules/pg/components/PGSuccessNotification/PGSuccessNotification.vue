<template>
  <div
    class="pg-success-notification"
    :class="{ 'pg-success-notification--mint': type === 'mint' }"
  >
    <div class="pg-success-notification__badge">
      <div class="pg-success-notification__img-cont">
        <img
          ...
          alt="confetti emoji"
          class="pg-success-notification__img-el"
        />
        <div
          class="pg-success-notification__backdrop pg-success-notification__backdrop--1"
        ></div>
        <div
          class="pg-success-notification__backdrop pg-success-notification__backdrop--2"
        ></div>
      </div>
    </div>
    <h3 class="h3 pg-success-notification__header">
      {{ $t('pgSuccessNotification.header') }}
    </h3>
