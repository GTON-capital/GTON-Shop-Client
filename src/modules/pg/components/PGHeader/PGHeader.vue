<template>
  <header class="pg-header">
    ...
    <div
      class="pg-header__col pg-header__col--burger"
      @click="isMobileNavOpen = !isMobileNavOpen"
    >
      <button
        class="pg-header__hamburger"
        :class="{ 'pg-header__hamburger--open': isMobileNavOpen }"
      >
    ...
    <nav
      class="pg-header__mobile-nav"
      :class="{ 'pg-header__mobile-nav--active': isMobileNavOpen }"
    >
