  ...
  >
    ...
    <div class="nftcreate_col">
        ...
        <div class="nftcreate_panel">
          ...
          >
            <template #label>
              ...
              <span
                class="label_btn"
                :data-tooltip="$t('nftcreate.royaltyTooltip')"
              >
                <app-iconset
                  icon="question"
                  :aria-hidden="false"
          ...
          <f-form-input field-size="large" type="text" name="linkToIp">
            <template #label>
              ...
              <span
                class="label_btn"
                :data-tooltip="$t('nftcreate.linkToIpTooltip')"
              >
                <app-iconset
                  icon="question"
                  :aria-hidden="false"
      ...
      <div
        ...
        class="pat-5 flex juc-center progress-message"
      >
      ...
      <a-sign-transaction
        :tx="tx"
        @transaction-status="onMintTransactionStatus"
      />
    </div>
  </f-form>
</template>
...
export default {
  ...
  data() {
    return {
      values: {
        collectionId: '0xBF29277AdD1E4f142D37F46eFc02Fc1d8beB7897', // Default Artion Collection
      },
      collections: [],
      collection: {},
      imageFile: null,
  ...
  methods: {
    ...
    async onSubmit(_data) {
      ...
      this.collection = this.collections.filter(
        col => col.value === val.collectionId
      )[0];
    ...
    async getMintedTokenId(txHash) {
      ...
      if (receipt === null) {
        console.log(
          'getTransactionReceipt return null receipt for ' +
            txHash +
            ' - not in chain yet?'
        );
        return null;
