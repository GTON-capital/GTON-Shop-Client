<template>
  <div class="nftredeem">
    ...
    <!-- PG -->
    <p>
      Our team will be in touch with further details regarding the delivery of
      physical items and to schedule the meet and greet and VIP expreience.
    </p>
    <!-- /PG -->
    <p>
    ...
    onTransactionStatus(payload) {
      ...
      if (this.txStatus === 'success') {
        this.$notifications.add({
          text: this.$t('nftredeem.redeemingSuccessful', {
