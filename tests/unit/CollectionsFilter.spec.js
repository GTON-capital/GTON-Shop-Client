...
function getCollections() {
  return [
    {
      img:
        'https://cloudflare-ipfs.com/ipfs/QmP8idjiQxFZ1Wpe61fSmi6jPTT48apPEx4QVKDhhWNWya',
      label: 'Default GTON Shop Collection',
      value: 'default-gton-shop-collection',
    },
    {
      img:
        'https://cloudflare-ipfs.com/ipfs/QmTTvJNrWky6AikiPx6LsFBazRaX47z7XKiiyZVS7x4hHE',
      label: 'Rarity Crafting',
      value: 'rarity-crafting',
    },
    {
      img:
        'https://cloudflare-ipfs.com/ipfs/QmcerMnM1z9fVoQxAbCi5HeHessCSrpDMd5YBGG54ti5YU',
      label: 'Pumpkittens',
      value: 'pumpkittens',
    },
  ];
...
const VModelTest = getVModelComponent(CollectionsFilter, {
...
function createWrapper({
  propsData = { collections: getCollections() },
  slots = {},
} = {}) {
...
describe('CollectionsFilter', () => {
  ...
  it('should properly handle v-model', async () => {
    ...
    const collectionsFilter = wrapper.findComponent({
